...
2. The position of the eye with respect to its center of rotation, which is the current planet position. More precisely, we scale and rotate (around `x` and `y` axes) the base vector from z axis.
